...
const GrossPayTable = () => {
  const columns = [
    {
      title: () => {
        return <p className="fs-20 fw-500 m-0"style={{color:"#4E4B66"}}>Description</p>
      },
    ...
    {
      title: () => {
        return <p className="fs-20 fw-500 m-0" style={{color:"#4E4B66"}}>Units</p>
      },
      dataIndex: "units",
      key: "units",
    },
    {
      title: () => {
        return <p className="fs-20 fw-500 m-0" style={{color:"#4E4B66"}}>Rate (£)</p>
      },
      dataIndex: "rate",
      key: "rate",
    },
    {
      title: () => {
        return <p className="fs-20 fw-500 m-0" style={{color:"#4E4B66"}}>Amount (£)</p>
      },
      dataIndex: "amount",
      key: "amount",
    },
