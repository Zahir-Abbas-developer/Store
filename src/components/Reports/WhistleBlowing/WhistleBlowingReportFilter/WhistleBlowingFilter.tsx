...
const IncidentReportFilter = (props: any) => {
  const { dayAvailability, setFilterValues, handleExtraHours } = props;
  ...
  return (
    <Row gutter={[20, 20]} className='staff-availability-sheet-common-filter-wrapper' justify="space-between">
      ...
      <AddModal title={<span className='fw-500 fs-20 titile-color'>Whistle Blowing</span>} IsOpenIncidentAddModal={IsOpenIncidentAddModal} IsCancelIncidentAddModal={() => setIsOpenIncidentAddModal(false)} />
