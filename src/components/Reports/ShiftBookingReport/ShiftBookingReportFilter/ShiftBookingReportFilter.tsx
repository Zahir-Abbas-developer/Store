...
const ShiftBookingReportFilter = (props: any) => {
      ...
      <Col xs={24} md={16} xl={14} xxl={12}>
        <Row gutter={[0, 20]} className="filter-wrapper">
          ...
          <Col xs={24} sm={8}>
            ...
            <div className="filter-column">
              <RangePicker onChange={(values: any) => { !values ? setFilterValues({ startDate: "", endData: "" }) : setFilterValues({ startDate: dayjs(values[0]).toISOString(), endData: dayjs(values[1]).toISOString() }) }} className='date-picker ' suffixIcon={<img src={datePicker} alt="calander" />} />
            </div>
          </Col>
...
export default ShiftBookingReportFilter