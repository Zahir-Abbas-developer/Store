...
const PaySlipModal = (props: any) => {
  const { isOpenPaySlipModal, setIsOpenPaySlipModal } = props;
  ...
  return (
    <Modal
      ...
      footer={false}
      open={isOpenPaySlipModal}
      onOk={() => {
        setIsOpenPaySlipModal(false);
      }}
      onCancel={() => {
        setIsOpenPaySlipModal(false);
      }}
    ...
    >
      <Fragment>
        ...
        <Row gutter={[25, 10]} style={{ marginTop: "2rem", height: "40rem", overflowY: "scroll" }}>
          <Col xs={24}>
            <h3 className="fs-22 m-0 fw-500">Pay Slip</h3>
            {tableHeaderDetails.map((data) => {
              return (
                <Row className="details-wrapper align-center">
                  <Col xs={12} md={6} xl={4} xxl={3}>
                    <p className="fs-14 fw-400 m-0" style={{ color: "#6E7191" }}>
                      {data.heading}
                    </p>
                  </Col>
                  <Col xs={12} md={6} xl={4} xxl={3} className="text-end">
                    <p className="fs-4 fw-500 m-0">{data.details}</p>
                  </Col>
                </Row>
              );
            })}
          ...
          <Col xs={24}>
            <div className="main-heading">
              <h2 className="fs-20 fw-500 m-0">GROSS PAY</h2>
            </div>
          </Col>
          ...
          <Col xs={24}>
            <div className="main-heading">
              <h2 className="fs-20 fw-500 m-0">DEDUCTIONS/ADJUSTMENTS</h2>
            </div>
          </Col>
          <Col xs={24} md={24} style={{ margin: "1rem 0" }}>
            <div className="table-wrapper">
          ...
          <Col xs={24} className="text-center fs-16" style={{ color: "#000", marginTop: "3rem" }}>
            <p className="m-0">Suite 6 office I-K </p>
            <p className="m-0">Uxbridge</p>
            <p className="m-0">Accounts@carelibrary.co.uk</p>
            <p className="m-0">Company Registration No. 12988445</p>
          </Col>
        </Row>
      </Fragment>
    </Modal>
