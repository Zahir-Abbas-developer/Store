...
import { useGetStaffAvailabilityQuery, useStaffAvailabilitysheetMutation } from "../../../../../../../store/Slices/StaffManager";
        ...
        <div className="select-availability-modal">
          ...
          >
            <div>
              ...
              ></div>
              <div><p className="m-0 fs-14 fw-400" style={{ color: '#A0A3BD' }}>Long Day</p></div>
            </div>
            <div>
              <div
                onClick={() => handleShift("MORNING")}
                className={`am-update d-flex justify-center align-center ${shiftType?.MORNING && "Morning-active"
                  }`}
              >
                <h3 className="m-0 fs-20 fw-500 line-height-17">A M</h3>
              </div>
              <p className="m-0 fs-14 fw-400" style={{ color: '#A0A3BD' }}>Morning</p>
            </div>
            <div>
              <div
                onClick={() => handleShift("AFTERNOON")}
                className={`pm-update d-flex justify-center align-center ${shiftType?.AFTERNOON && "Afternoon-active"
                  }`}
              >
                <h3 className="m-0 fs-20 fw-500 line-height-17">P M</h3>
              </div>
              <p className="m-0 fs-14 fw-400" style={{ color: '#A0A3BD' }}>Afternoon</p>
            </div>
            <div>
              <div
              ...
              ></div>
              <p className="m-0 fs-14 fw-400" style={{ color: '#A0A3BD' }}>Night</p>
            </div>
          </div>
