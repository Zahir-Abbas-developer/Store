...
const TotalHoursLifeTime = () => {
  ...
  const { data, isLoading, isSuccess, isError } = useGetWorkHistoryQuery({
  ...
  return (
    <>
      ...
      <TotalHoursTable data={staffworkHistory?.data} isLoading={isLoading} pagination={pagination} setPagination={setPagination}/>
    </>
  );
};
